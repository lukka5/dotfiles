...
"
"     Edited (22/01/2014): Change #404040 for #000000
"     to match my current black background configuration.

"     Edited (24/01/2014): Change 238 for 0
"     to match my current black background configuration.
...
hi SpecialChar guifg=#c080d0 guibg=#000000 guisp=#000000 gui=NONE ctermfg=176 ctermbg=0 cterm=NONE
...
hi Cursor guifg=#000000 guibg=#8b8bff guisp=#8b8bff gui=NONE ctermfg=0 ctermbg=105 cterm=NONE
...
hi String guifg=#ffcd8b guibg=#000000 guisp=#000000 gui=NONE ctermfg=222 ctermbg=0 cterm=NONE
hi PMenuThumb guifg=#eeeeee guibg=#6e6eaf guisp=#6e6eaf gui=NONE ctermfg=255 ctermbg=61 cterm=NONE
hi MatchParen guifg=#000000 guibg=#8fff8b guisp=#8fff8b gui=NONE ctermfg=0 ctermbg=120 cterm=NONE
...
hi cursorim guifg=#000000 guibg=#8b8bff guisp=#8b8bff gui=NONE ctermfg=0 ctermbg=105 cterm=NONE
"hi clear -- no settings --
hi lcursor guifg=#000000 guibg=#8fff8b guisp=#8fff8b gui=NONE ctermfg=0 ctermbg=120 cterm=NONE
...
hi perlspecialstring guifg=#c080d0 guibg=#000000 guisp=#000000 gui=NONE ctermfg=176 ctermbg=0 cterm=NONE
...
hi perlspecialmatch guifg=#c080d0 guibg=#000000 guisp=#000000 gui=NONE ctermfg=176 ctermbg=0 cterm=NONE
hi cformat guifg=#c080d0 guibg=#000000 guisp=#000000 gui=NONE ctermfg=176 ctermbg=0 cterm=NONE
...
hi cspecialcharacter guifg=#c080d0 guibg=#000000 guisp=#000000 gui=NONE ctermfg=176 ctermbg=0 cterm=NONE
